...
class SyncConfig(QDialog):
    ...
    def load_saved_config(self) -> bool:
        self.controller.config = ProjectConfig.load_from_file(self.controller.binary_path() or "")
    ...
    def save_config(self) -> Optional[str]:
        ...
        return self.controller.config.save() if self.controller.config else None
