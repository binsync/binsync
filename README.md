...
<p align="center">
    <img src="./assets/images/sponsors/nsf.png" alt="NSF" style="height: 60px; display: inline-block; vertical-align: middle; margin-right: 20px;">
    <img src="./assets/images/sponsors/darpa.png" alt="DARPA" style="height: 60px; display: inline-block; vertical-align: middle; margin-right: 20px;">
    <img src="./assets/images/sponsors/arpah.svg" alt="ARPA-H" style="height: 60px; display: inline-block; vertical-align: middle; margin-right: 20px;">
