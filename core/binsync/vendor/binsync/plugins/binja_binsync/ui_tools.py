...
# Thanks @NOPDev
from .... import binsync
from ....binsync import common as ___vendorize__0
binsync.common = ___vendorize__0
from ....binsync.common import controller as ___vendorize__1
binsync.common.controller = ___vendorize__1
